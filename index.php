...
<head>
  ...
  <meta name="description" content="We are a Vibrant Christian Community passionate about the gospel and more earnest to share Love, Hope and Faith. We welcome all individuals to come grow with us spiritually and impact positively other people they connect with...">
  <meta name="keywords" content="otubanga, ebenezer, aliba, obongi, nursery, primary, blog, online church, pentecostal church group, jesus christ, salvation">
  ...
  <style>
    body {
      background: url(./assets/biblestudy.jpg);
...
<body>
  <div class="p-0 m-0 index">
    <div class="container-fluid m-0 p-0">
      <div class="headerx">
        <nav class="navbar navbar-expand-sm navbar-dark bg-prima sticky-top" id="nav">
          <div class="container">
            <div>
          ...
          <div class="py-md-5 introx">
            ...
            <div class="row p-md-5 p-sm-2 p-xs-1">
              ...
              <div class="vision-mission text-center py-md-5 rounded-4 text-light col-md-7 col-sm-10 shadow me-0">
                ...
                <p class=" animate__animated animate__slideInDown">A HEALTHY COMMITTED COMMUNITY BASED LOCAL CHURCH
                  REACHING
                  OUT
          ...
          <div class="carousel-inner" role="listbox">
            ...
            <div class="carousel-item">
              ...
              <div class="carousel-caption d-none d-md-block">
                ...
                <a href="#community" class="btn btn-outline-light animate__animated animate__slideInUp" data-aos="fade-up">View our Community</a>
              </div>
            </div>
            <div class="carousel-item">
          ...
          <div class="col-md-4 col-sm-6 my-1">
            <div class="card h-100 shadow" data-aos="fade-right">
              <div class="blur-load" style="background-image: url(./assets/Picture1-small.png);">
                <img class="card-img-top img-fluid w-100 m-auto rounded" loading="lazy" src="./assets/Picture1.png" alt="Title">
              </div>
          ...
          <div class="col-md-4 col-sm-6 my-1">
            <div class="card h-100 shadow" data-aos="fade-up">
              <div class="blur-load" style="background-image: url(./assets/Picture2-small.png);">
                <img class="card-img-top w-100 m-auto rounded" src="./assets/Picture2.png" loading="lazy" alt="Title">
              </div>
              <div class="card-body text-center">
          ...
          <div class="col-md-4 col-sm-6 my-1">
            <div class="card h-100 shadow" data-aos="fade-left">
              <div class="blur-load" style="background-image: url(./assets/Picture3-small.png);">
                <img class="card-img-top w-100 m-auto rounded" src="./assets/Picture3.png" loading="lazy" alt="Title">
              </div>
              <div class="card-body text-center">
    ...
    <div class="container-fluid">
      <div class="container my-md-4 py-md-5 align-items-center" id="contact">
        ...
        <div class="d-md-flex mt-3 align-items-center">
          ...
          <form action="" class="col-md-7 col-sm-12 m-auto bg-light p-3 rounded contact shadow" method="POST" data-aos="fade-left">
        ...
        <div class="container py-5">
          <div class="row mt-5">
            ...
            <div class="col-md-6 col-lg-3">
              ...
              <h5>Reach US</h5>
              <ul>
                <li><i class="bx bx-phone"></i> +256-786-976-963</li>
                <li><i class="bx bx-phone"></i> +256-770-706-466</li>
                <li><i class="bx bx-phone"></i> +256-775-600-507</li>
